...
export const contracts = {
  ...
  activities: {
    ...
    repository: { tags: ['Activities'], security: [{ bearerAuth: [] }], request: { params: sharedSchemas.repoParam, query: sharedSchemas.paginationQuery }, responses: { 200: sharedSchemas.successEnvelope(activityListData) } },
  },
  pullRequests: {
